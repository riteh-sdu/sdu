...
long int i_VN = 0, i_NN = 0; 									// brojaèi za napone (visoki i niski)
long int i_mz_pov = 0, i_mz_U = 0, i_mz_V = 0;					// brojaci za struje (mali zateg)
long int i_vz_pov = 0, i_vz_U = 0, i_vz_V = 0;					// brojaci za struje (veliki zateg)
...
int test_Ivz_U = 0, test_Ivz_V = 0, test_Ivz_pov = 0;		// detekcija struja sa velikim zategom
...
void Interupt_2(void){
	...
	if (i_mz_pov >= T_mz){
		test_Imz_pov = 1;		// signaliziraj da je struja veæa od granice za mali zateg
	}
	// Struja faze U
	if (IU < Ig_mz){
		test_Imz_U = 0;
	...
	if (i_mz_U >= T_mz){
		test_Imz_U = 1;			// signaliziraj da je struja veæa od granice za mali zateg
	}
	// Struja faze V
	if (IV < Ig_mz){
		test_Imz_V = 0;
	...
	if (i_mz_V >= T_mz) {
		test_Imz_V = 1;			// signaliziraj da je struja veæa od granice za mali zateg
	}
	...
	if (i_vz_pov >= T_vz) {
		test_Ivz_pov = 1;		// signaliziraj da je struja veæa od granice za veliki zateg
	}
	...
	if (i_vz_U >= T_vz) {
		test_Ivz_U = 1;			// signaliziraj da je struja veæa od granice za veliki zateg
	}
	...
	if (i_vz_V >= T_vz) {
		test_Ivz_V = 1;			// signaliziraj da je struja veæa od granice za veliki zateg
	}
