	...
	//
	//	Zadatak:
	//		o	Pomoæu potenciometara je potrebno upravljati brzinom LED brojaèa
	//		o	Frekvencija promjene LED-ica treba biti izmeðu 50 Hz i 1 kHz
	//		o
	//
	//	Komentari:	*
	//
...
void main(void)
 {
	...
	while(1)
	{
			...
			ConfigCpuTimer(&CpuTimer0,150,200000-190000*Voltage_VR1);			// Konfiguriranje brojaèa izmeðu 50Hz-1kHz
